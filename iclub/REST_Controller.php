...
abstract class REST_Controller extends MY_Controller
{
	...
	public function check_auth_api()
	{
		...
		if($check_auth)
		{
			...
			$this->authenticate->app_token	=$this->input->get('token');

			$returnData=$this->authenticate->checkToken();

			if($returnData['code']!='200'){
				$response['header']	= $returnData;
